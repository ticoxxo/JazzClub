    ...
    public partial class paymenttype : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseDays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseDays_Courses_CoursesCourseId",
                        column: x => x.CoursesCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseDays_Days_DaysDayId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDays_CoursesCourseId",
                table: "CourseDays",
                column: "CoursesCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseDays_DaysDayId",
                table: "CourseDays",
                column: "DaysDayId");
